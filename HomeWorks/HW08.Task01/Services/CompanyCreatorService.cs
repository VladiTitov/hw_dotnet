...
using System.Linq;
using HW08.Task01.Models;
using HW08.Task01.Constants;

namespace HW08.Task01.Services
{
    class CompanyCreatorService
    {
        private readonly Random _random = new Random();

        private Dictionary<string, List<Engineer>> _companyAndEmployeesDictionary = new Dictionary<string, List<Engineer>>();
        ...
        {
            var employees = _companyAndEmployeesDictionary[company].OrderByDescending(i => i.Experience);

            foreach (var engineer in employees)
                Console.WriteLine($"Company: {company}, {engineer}");
        }

        private void CreateDictionary(int n, ref Dictionary<string, List<Engineer>> dictionary)
        {
